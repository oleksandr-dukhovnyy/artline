<template>
	<div class="modal" @click.self.stop="clickOutside">
		<div
			v-if="modalType === 'confirm'"
			class="modal-confirm animate__animated animate__fadeInUp"
		>
			<p class="modal-confirm-text" v-html="text"></p>
			<div class="modal-confirm-controlls">
				<button class="modal-confirm-controlls-ok" @click="confirm('ok')">
					ok
				</button>
				<button
		...
		>
			<p class="modal-prompt-text" v-html="text"></p>
			<input
				type="text"
				v-model="promptText"
			...
			<div class="modal-prompt-controlls">
				<button class="modal-prompt-controlls-ok" @click="prompt('ok')">
					ok
				</button>
				<button class="modal-prompt-controlls-cancel" @click="prompt('cancel')">
					cancel
				</button>
			</div>
		</div>
