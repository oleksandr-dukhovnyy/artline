<template>
	<header class="header animate__animated animate__fadeIn">
		<div class="header-logo">
			<router-link class="header-logo-text" :to="{ name: 'home' }"
				>ARTLINE</router-link
			>
		</div>
		...
		<nav class="header-navbar"
			v-else
		>
			<router-link class="header-navbar-link" :to="{ name: 'login' }">
				Login
			</router-link>
			<router-link class="header-navbar-link" :to="{ name: 'registration' }">
				Registration
			</router-link>
		</nav>
